...
enum { CRSF_FRAME_SIZE_MAX = 64 }; // total bytes on the wire: addr + size + type + payload + crc
enum { CRSF_PAYLOAD_SIZE_MAX = CRSF_FRAME_SIZE_MAX - 4 }; // overhead = addr + size + type + crc
